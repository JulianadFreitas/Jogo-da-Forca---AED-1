...
def principal():
    ...
    valor_determinate_equacao=random.randrange(0,8)
    resultado=0
    simbolo1=0
    simbolo2=0
    simbolo3=0
    try:
     if valor_determinate_equacao == True:
      resultado=valor1-valor2*valor3+valor4
      simbolo1="-"
      simbolo2="*"
      simbolo3="+"    
     if valor_determinate_equacao == 1:
      resultado=valor1*valor2-valor3/valor4
      simbolo1="*"
      simbolo2="-"
      simbolo3="/" 
     if valor_determinate_equacao == 2:
      resultado=valor1/valor2+valor3-valor4
      simbolo1="/"
      simbolo2="+"
      simbolo3="-"      
     if valor_determinate_equacao == 3:
      resultado=valor1-valor2-valor3-valor4
      simbolo1="-"
      simbolo2="-"
      simbolo3="-"      
     if valor_determinate_equacao == 4:
      resultado=valor1+valor2+valor3+valor4
      simbolo1="+"
      simbolo2="+"
      simbolo3="+" 
     if valor_determinate_equacao == 5:
      resultado=valor1-valor2/valor3-valor4
      simbolo1="-"
      simbolo2="/"
      simbolo3="-" 
     if valor_determinate_equacao == 6:
      resultado=valor1/valor2+valor3*valor4 
      simbolo1="/"
      simbolo2="+"
      simbolo3="*"    
     if valor_determinate_equacao == 7:
      resultado=valor1*valor2-valor3*valor4
      simbolo1="*"
      simbolo2="-"
      simbolo3="*" 
        ...
        print("ERRO")
        entrada="Divisão por zero em divisão na equação aleatoria!"
        erro(entrada)
    resultado=float(resultado)
    resultado=('%.2f' % (resultado))
    string_de_saida=valor1,"------",valor2,"------",valor3,"-----",valor4,"=",resultado
    print(simbolo1,simbolo2,simbolo3)
    ...
    titulo=Text(ponto_titulo,"Forca númerica 0.1 \n Não deixe o triangulo 3D se formar")
    titulo.draw(win)
    #vetor do triangulo
    P1=Point(165,180)
    P2=Point(205,180)
    ...
    l2=True
    l3=True
    if simbolo1==0 or simbolo2==0 or simbolo3==0:
        entrada="Retorno de operação invalido"
        erro(entrada)
